    ...
    boolean joinGroupIfNeeded(final Timer timer) {
        while (rejoinNeededOrPending()) {
            ...
            if (future.succeeded()) {
                ...
                // Added in another PR as a customer configurable. The default if 100, so we'll use that
                timer.sleep(100);
            }
        }
        return true;
                ...
                public void onSuccess(ByteBuffer value) {
                    ...
                    synchronized (AbstractCoordinator.this) {
                        if (generation != Generation.NO_GENERATION) {
                            ...
                            rejoinNeeded = false;
                            // https://github.com/apache/kafka/pull/7347/files shows these are just metrics
